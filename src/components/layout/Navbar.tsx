...
import { LayoutDashboard, Activity, Tractor, UserPlus, Menu, X, Leaf } from 'lucide-react';
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <NavLink to="/" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-display text-lg font-bold text-foreground">HillSmart</h1>
            ...
            <div className="flex items-center gap-1">
              {navItems.map((item) => (
                <NavLink
                  ...
                  to={item.to}
                  className={({ isActive }) =>
                    `nav-link rounded-lg ${isActive ? 'active bg-primary/10' : 'hover:bg-muted'}`
                  }
                >
      ...
      <nav className="sticky top-0 z-50 md:hidden bg-card/80 backdrop-blur-lg border-b border-border">
        <div className="flex h-14 items-center justify-between px-4">
          <NavLink to="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-bold text-foreground">AgriSmart</span>
          </NavLink>
          <button
